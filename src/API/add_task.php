...
if($_SERVER['REQUEST_METHOD']=='POST'){
   ...
   try {
    ...
    $stmt1=$pdo->prepare("insert into tasks(title,user_id,description,status,priority,deadline,project_id,created_at) values(:title,:user_id,:description,'Pending',:priority,:deadline,:project_id,now()) ");
